...
func ValidateConfig(cfg config.Config) error {
	return config.Validate(config.Loaded{
		...
		Sources: map[string]string{
			...
			config.FieldStatefulGroup:           "runner",
			config.FieldStatefulMember:          "runner",
			config.FieldStatefulGeneration:      "runner",
			config.FieldStatefulVolumeMountPath: "runner",
			config.FieldStatefulStableHostname:  "runner",
			config.FieldStatefulRecipe:          "runner",
			config.FieldReleaseManifestKey:      "runner",
			config.FieldRuntimeManifestKey:      "runner",
